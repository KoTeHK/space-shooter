...
def run():
    ...
    hero = Hero(100, 100, 200, 200,speed = 5, color= (5, 159, 67), image= hero_images)
    boss = None
    bg = Background(bg_image, 1)
    font_kill = pygame.font.Font(None, 40)
    #bot = Bot(500, 0 - 50, 100, 100, speed= 1, image= bot_images)
    ...
    while game:
        ...
        if which_window == 0:
            ...
            window.blit(font_kill.render(f"SCORE: {hero.KILL}", True, (0, 0, 0)), (setting_win["WIDTH"] - 180, 10))
                 #BOT                    
            if time_end - time_start > 2000 and hero.KILL_BOT_LVL < 3:
                bot_list.append(Bot(randint(0, setting_win["WIDTH"] - 100),
            ...
            for event in events:
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        hero.BULLETS.append(Bullet(bullet_image, 8, x= hero.x + hero.width // 2, y= hero.y, width= 5, height = 10))
